      ...
      <ResponsiveContentArea>
        <Card>
          ...
          <CardText>
            ...
            <ul>
              <li>
                To serve as a starting point for projects involving react/relay, materual-ui and
                Cassandra.
              </li>
              ...
              <li>
                ...
                while storing user accounts in Cassandra.
              </li>
            </ul>
        ...
        <br />
        <Card>
          <CardHeader title="GraphiQL" subtitle="Explore the GraphQL server" />
          <CardText>
            Please notice that the links below will work only when you set the
            {' '}<b>USER_TOKEN_2_BYPASS_IP</b> to be your browser's IP address. All other IPs will
            not be able to authenticate for security reasons. Use that option with caution. It is
            best if it is set to 127.0.0.1 as by default.
            <br />
            ...
            <a
              ...
              target="_blank"
            >
              Simple query requesting some of the viewer object type fields
            </a>
            <br />
            <a
              ...
              target="_blank"
            >
              Titles of the essays available in the system
            </a>
            <br />
            <a
