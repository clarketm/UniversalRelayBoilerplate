...
resolve:function resolve(_ref,args,context,_ref2){var arr_local_ids_Changed_ToDos=_ref.arr_local_ids_Changed_ToDos;var objectManager=_ref2.rootValue;return arr_local_ids_Changed_ToDos.map(function(local_id){return objectManager.getOneObject('ToDo',{id:local_id});});}},

Viewer:{
type:_ViewerType2.default,
resolve:function resolve(parent,args,context,_ref3){var objectManager=_ref3.rootValue;return objectManager.getOneObject('User',{id:objectManager.getViewerUserId()});}}},
...
return(0,_ToDo_list_updateMarkAll2.default)(objectManager,ToDo_Complete).
