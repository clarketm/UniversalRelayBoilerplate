...
resolve:function resolve(obj,_ref,context,_ref2){var status=_ref.status,args=_objectWithoutProperties(_ref,['status']);var objectManager=_ref2.rootValue;
...
arr.filter(
function(a_ToDo){return status==='any'||a_ToDo.ToDo_Complete===(status==='completed');}),
...
resolve:function resolve(obj,_ref3,context,_ref4){var args=_objectWithoutProperties(_ref3,[]);var objectManager=_ref4.rootValue;return(
objectManager.
getObjectList('ToDo',{
ToDo_User_id:objectManager.getViewerUserId()}).
...
ToDo_CompletedCount:{
type:_graphql.GraphQLInt,
resolve:function resolve(obj,_ref5,context,_ref6){var args=_objectWithoutProperties(_ref5,[]);var objectManager=_ref6.rootValue;return(
objectManager.
getObjectList('ToDo',{
ToDo_User_id:objectManager.getViewerUserId()}).
