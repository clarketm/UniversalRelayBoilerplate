...
function User_Properties(props,context){_classCallCheck(this,User_Properties);var _this=_possibleConstructorReturn(this,(User_Properties.__proto__||Object.getPrototypeOf(User_Properties)).call(this,
props,context));_this.
...
_this.state.User_AccountPasswordConfirmation);
...
_this.validateInputs(
_this.state.User_AccountPassword_Current,
event.target.value,
_this.state.User_AccountPasswordConfirmation);
...
_react2.default.createElement(_Card.CardHeader,{title:'User password'}),
...
color:
this.state.User_AccountPasswordStrength<_accountNameAndPasswordRequirements.AccountPasswordStrengthMin?
'#ff0000':
