...
{
if(AccountName.length<_accountNameAndPasswordRequirements.AccountNameLengthMin)
return false;
...
function AppBar_Auth(props,context)
{_classCallCheck(this,AppBar_Auth);var _this=_possibleConstructorReturn(this,(AppBar_Auth.__proto__||Object.getPrototypeOf(AppBar_Auth)).call(this,
props,context));_this.
...
_this._handle_onChange_AuthenticationChallenge_User_AccountName_or_Password(event.target.value,_this.state.User_AccountPassword);
};_this.

_handle_onKeyDown_AuthenticationChallenge_User_AccountName=function(e)
{
if(e.keyCode===13)
_this.refs.User_AccountPassword.focus();
};_this.
...
_this._handle_onChange_AuthenticationChallenge_User_AccountName_or_Password(_this.state.User_AccountName,event.target.value);
};_this.

_handle_onKeyDown_AuthenticationChallenge_User_AccountPassword=function(e)
{
if(e.keyCode===13)
_this._handle_onTouchTap_AuthenticationChallenge_LogIn();
};_this.

_handle_onChange_AuthenticationChallenge_User_AccountName_or_Password=function(AccountName,AccountPassword)
{
_this.setState({Account_information_Supplied:isAccountNameAcceptable(AccountName)&&AccountPassword.length>=_accountNameAndPasswordRequirements.AccountPasswordLengthMin});
};_this.
...
{
_this.setState({User_AccountName:event.target.value});
_this._handle_onChange_CreateUser_User_AccountName_or_Password(event.target.value,_this.state.User_AccountPassword);
};_this.
...
{
_this.setState({User_AccountPassword:event.target.value});
_this._handle_onChange_CreateUser_User_AccountName_or_Password(_this.state.User_AccountName,event.target.value);
};_this.

_handle_onKeyDown_CreateUser_User_AccountPassword=function(e)
{
if(e.keyCode===13)
_this._handle_onTouchTap_CreateUser_Create();
};_this.
...
_this.setState({
Account_information_Supplied:isAccountNameAcceptable(AccountName)&&AccountPassword.length>=_accountNameAndPasswordRequirements.AccountPasswordLengthMin,
