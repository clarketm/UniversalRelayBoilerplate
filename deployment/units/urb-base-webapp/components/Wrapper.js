...
};_this.rbCtx=(0,_getWrapperRbCtx2.default)(props.siteConfiguration);_this.rbCtx.viewportDimensions=new _ViewportDimensions2.default();_this.rbCtx.siteConfiguration=props.siteConfiguration;_this.muiTheme=(0,_createMUITheme2.default)(_this);return _this;}_createClass(Wrapper,[{key:'componentDidMount',value:function componentDidMount(){this.handle_onResize();}},{key:'getChildContext',value:function getChildContext(){return{rbCtx:this.rbCtx};}},{key:'render',value:function render()
