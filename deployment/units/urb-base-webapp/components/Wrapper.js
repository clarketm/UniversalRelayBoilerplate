...
};_this.rbCtx=(0,_getWrapperRbCtx2.default)();_this.rbCtx.viewportDimensions=new _ViewportDimensions2.default();_this.rbCtx.appData=_this.props.appData;_this.muiTheme=(0,_createMuiTheme2.default)({palette:{primary:_blue2.default,secondary:_pink2.default,type:'light'}});return _this;}_createClass(Wrapper,[{key:'componentDidMount',value:function componentDidMount(){this.handle_onResize();}},{key:'getChildContext',value:function getChildContext(){return{rbCtx:this.rbCtx};}},{key:'render',value:function render()
