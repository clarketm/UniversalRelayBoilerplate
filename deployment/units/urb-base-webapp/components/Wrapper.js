...
var _ViewportDimensions=require('../scripts/ViewportDimensions');var _ViewportDimensions2=_interopRequireDefault(_ViewportDimensions);
var _getWrapperRbCtx=require('../../_configuration/urb-base-webapp/getWrapperRbCtx');var _getWrapperRbCtx2=_interopRequireDefault(_getWrapperRbCtx);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var
...
};_this.rbCtx=(0,_getWrapperRbCtx2.default)();_this.rbCtx.viewportDimensions=new _ViewportDimensions2.default();_this.rbCtx.appData=_this.props.appData;_this.muiTheme=(0,_styles.createMuiTheme)({palette:(0,_palette2.default)({primary:_blue2.default,accent:_pink2.default,type:'light'})});return _this;}_createClass(Wrapper,[{key:'componentDidMount',value:function componentDidMount(){this.handle_onResize();}},{key:'getChildContext',value:function getChildContext(){return{rbCtx:this.rbCtx};}},{key:'render',value:function render()
