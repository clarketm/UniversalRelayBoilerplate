...
_this.state={propertiesIsOpen:false};return _this;
}_createClass(NavBarLoginButton,[{key:'render',value:function render()
...
_react2.default.createElement(_Button2.default,{color:'contrast'},'Login')));


}}]);return NavBarLoginButton;}(_react2.default.Component);NavBarLoginButton.propTypes={classes:_propTypes2.default.object.isRequired,Viewer:_propTypes2.default.object.isRequired,relay:_propTypes2.default.object.isRequired};exports.default=
