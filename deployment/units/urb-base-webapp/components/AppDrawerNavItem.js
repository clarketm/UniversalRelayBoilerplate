...
AppDrawerNavItem=function(_Component){_inherits(AppDrawerNavItem,_Component);function AppDrawerNavItem(){var _ref;var _temp,_this,_ret;_classCallCheck(this,AppDrawerNavItem);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=AppDrawerNavItem.__proto__||Object.getPrototypeOf(AppDrawerNavItem)).call.apply(_ref,[this].concat(args))),_this),_this.
...
}}]);return AppDrawerNavItem;}(_react.Component);AppDrawerNavItem.defaultProps={openImmediately:false};
...
(0,_styles.withStyles)(styleSheet)(AppDrawerNavItem);
