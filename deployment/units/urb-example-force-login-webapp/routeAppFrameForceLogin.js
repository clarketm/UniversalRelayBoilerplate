...
_react2.default.createElement(_reactCodeSplitting2.default, { load: Promise.resolve().then(() => require('./components/ForceLogin')), componentProps: props });exports.default =
...
_react2.default.createElement(_Route2.default, { key: 'force-login', path: 'force-login' },
  _react2.default.createElement(_Route2.default, {
    ...
    query: function () {return require('./__generated__/routeAppFrameForceLogin_ForceLogin_Query.graphql');} }));
