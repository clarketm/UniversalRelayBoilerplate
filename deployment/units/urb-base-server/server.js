...
// Main router
const server = (0, _express2.default)(); // Add headers
...
server.use((0, _cookieParser2.default)()); // GraphQL server
...
server.use('/healthz', _serverHealthz2.default); // Staticpublic files server
server.use(
