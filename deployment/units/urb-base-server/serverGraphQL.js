...
serverGraphQL.use(function(req,res,next){return(0,_logServerRequest2.default)(req,res,next,_requestLoggers.requestLoggerGraphQL);});
...
(0,_checkCredentials.getUserAndSessionIDByUserToken1)(objectManager,req));case 7:a_User=_context.sent.User;
