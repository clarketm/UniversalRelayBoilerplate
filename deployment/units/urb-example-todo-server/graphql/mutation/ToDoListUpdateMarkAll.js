...
mutateAndGetPayload:function mutateAndGetPayload(_ref4,context,_ref5){var ToDo_Complete=_ref4.ToDo_Complete;var objectManager=_ref5.rootValue;var arr_local_ids_Changed_ToDos;return regeneratorRuntime.async(function mutateAndGetPayload$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return regeneratorRuntime.awrap(
(0,_ToDoListUpdateMarkAll2.default)(objectManager,ToDo_Complete));case 2:arr_local_ids_Changed_ToDos=_context.sent;return _context.abrupt('return',

{arr_local_ids_Changed_ToDos:arr_local_ids_Changed_ToDos});case 4:case'end':return _context.stop();}}},null,_this);}});exports.default=_default;;var _temp=function(){if(typeof __REACT_HOT_LOADER__==='undefined'){return;}__REACT_HOT_LOADER__.register(_default,'default','units/urb-example-todo-server/graphql/mutation/ToDoListUpdateMarkAll.js');}();;
