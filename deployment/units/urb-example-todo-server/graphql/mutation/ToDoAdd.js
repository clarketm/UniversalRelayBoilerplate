...
objectManager.getOneObject('ToDo',{id:local_id}));case 2:an_Object=_context.sent;_context.next=5;return regeneratorRuntime.awrap(
...
mutateAndGetPayload:function mutateAndGetPayload(_ref5,context,_ref6){var ToDo_Text=_ref5.ToDo_Text;var objectManager=_ref6.rootValue;var local_id;return regeneratorRuntime.async(function mutateAndGetPayload$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return regeneratorRuntime.awrap(
