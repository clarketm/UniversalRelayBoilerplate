...
arr.filter(function(a_ToDo){return status==='any'||a_ToDo.ToDo_Complete===(status==='completed');}),
...
resolve:function resolve(obj,_ref3,context,_ref4){var args=_objectWithoutProperties(_ref3,[]);var objectManager=_ref4.rootValue;var arr;return regeneratorRuntime.async(function resolve$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return regeneratorRuntime.awrap(
objectManager.getObjectList('ToDo',{
...
resolve:function resolve(obj,_ref5,context,_ref6){var args=_objectWithoutProperties(_ref5,[]);var objectManager=_ref6.rootValue;var arr;return regeneratorRuntime.async(function resolve$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_context3.next=2;return regeneratorRuntime.awrap(
objectManager.getObjectList('ToDo',{
