...
resolve:function resolve(obj,_ref,context,_ref2){var args=_objectWithoutProperties(_ref,[]);var objectManager=_ref2.rootValue;return objectManager.getObjectList('Ensayo',{Ensayo_User_id:objectManager.getViewerUserId()}).then(function(arr){return(0,_graphqlRelay.connectionFromArray)(arr,args);});}},

Ensayo:{
type:_EnsayoType2.default,
args:_extends({id:{type:_graphql.GraphQLID}}),
resolve:function resolve(parent,_ref3,context,_ref4){var id=_ref3.id;var objectManager=_ref4.rootValue;return objectManager.getOneObject('Ensayo',{id:(0,_graphqlRelay.fromGlobalId)(id).id});}}};
