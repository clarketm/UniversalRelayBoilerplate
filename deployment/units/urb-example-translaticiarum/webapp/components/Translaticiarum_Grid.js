...
if(transliticiarumDay==null)
cell=(0,_Translaticiarum_Icon2.default)(translaticiarumType);else
{
cell="-";
...
cell+=(0,_DateTimeHelpers.dateFormat)((0,_DateTimeHelpers.dateUTCToLocal)(new Date(a_Translaticiarum.Translaticiarum_Time)),"h:mmtt");}
...
return(
_react2.default.createElement('td',{style:{width:100},key:transliticiarumDay},cell));
...
var numberOfDays=Math.floor((this.context.rbContext.viewportDimensions.get(this,'contentWidth')-120)/100);
...
_this2.renderCell(TranslaticiarumByDateAndType,translaticiarumType,transliticiarumDay));})));}))),
