...
resolve:function resolve(_ref,_ref2,context,_ref3)
{var local_id=_ref.local_id;var args=_objectWithoutProperties(_ref2,[]);var objectManager=_ref3.rootValue;
...
then(function(){return objectManager.getObjectList('Translaticiarum',{Translaticiarum_User_id:objectManager.getViewerUserId()});}).
...
mutateAndGetPayload:function mutateAndGetPayload(_ref5,context,_ref6){var Translaticiarum_Type=_ref5.Translaticiarum_Type,Translaticiarum_Date=_ref5.Translaticiarum_Date,Translaticiarum_Time=_ref5.Translaticiarum_Time;var objectManager=_ref6.rootValue;return(
