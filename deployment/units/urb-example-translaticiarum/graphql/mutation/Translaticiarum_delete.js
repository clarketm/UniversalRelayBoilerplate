...
mutateAndGetPayload:function mutateAndGetPayload(_ref3,context,_ref4){var id=_ref3.id;var objectManager=_ref4.rootValue;
var local_id=(0,_graphqlRelay.fromGlobalId)(id).id;
return objectManager.remove('Translaticiarum',{id:local_id}).then(function(){return{id:id};});
}});
//# sourceMappingURL=Translaticiarum_delete.js.map