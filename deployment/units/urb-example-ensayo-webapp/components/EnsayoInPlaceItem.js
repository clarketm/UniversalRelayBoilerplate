...
EnsayoInPlaceItem=function(_React$Component){_inherits(EnsayoInPlaceItem,_React$Component);
...
};_this.state={anchorEl:undefined,menuIsOpen:false,propertiesIsOpen:false};return _this;}_createClass(EnsayoInPlaceItem,[{key:'render',value:function render()
...
}}]);return EnsayoInPlaceItem;}(_react2.default.Component);EnsayoInPlaceItem.propTypes={Viewer:_propTypes2.default.object.isRequired,Ensayo:_propTypes2.default.object.isRequired,relay:_propTypes2.default.object.isRequired};exports.default=


(0,_reactRelay.createFragmentContainer)(EnsayoInPlaceItem,{
Viewer:function(){return require('./__generated__/EnsayoInPlaceItem_Viewer.graphql');},




Ensayo:function(){return require('./__generated__/EnsayoInPlaceItem_Ensayo.graphql');}});
//# sourceMappingURL=EnsayoInPlaceItem.js.map