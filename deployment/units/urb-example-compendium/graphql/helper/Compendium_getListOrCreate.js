...
getObjectList('Compendium',{Compendium_User_id:objectManager.getViewerUserId()}).
then(function(arr){
if(arr.length>0)return arr;else
{
...
return objectManager.add('Compendium',compendium).then(function(local_id){
