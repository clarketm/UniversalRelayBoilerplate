...
_react2.default.createElement(_reactNativeRouterFlux.Scene,{key:'/user/login',title:'Login',component:_Login2.default,leftButton:MenuButton,initial:isAnonymous}),
_react2.default.createElement(_reactNativeRouterFlux.Scene,{key:'/todo',leftButton:MenuButton,initial:!isAnonymous},
_react2.default.createElement(_reactNativeRouterFlux.Scene,{key:'/todo-default-nourl',title:'To Do',component:_ToDoScreen2.default,queries:viewerQuery})),

_react2.default.createElement(_reactNativeRouterFlux.Scene,{key:'/user/logout',title:'Logout',component:_Logout2.default,queries:viewerQuery,leftButton:MenuButton})));
