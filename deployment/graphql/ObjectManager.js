...
entityDefinition.Persister.getObjectList(entityName,entityType,filter));});else
...
if(entityName=='User')
if(filter.id==_defaultPersister2.default.uuidNullAsString())return Promise.resolve(User_0);
