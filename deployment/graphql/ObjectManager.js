...
var User_0=new _User2.default(_extends((0,_getNewUser2.default)(),{
...
var loadersList=multipleResults?this.getLoadersMultiple(entityName):this.getLoadersSingle(entityName);
var loader=loadersList[fieldName];
if(loader==null){
if(multipleResults)
loader=new _dataloader2.default(function(filter){return entityDefinition.Persister.getObjectList(entityName,entityType,filter);});else

loader=new _dataloader2.default(function(filter){return entityDefinition.Persister.getOneObject(entityName,entityType,filter);});
...
entityDefinition.Persister.add(entityName,fields,entityDefinition.EntityType));case 9:
...
this.executeTriggers(entityDefinition.TriggersForUpdate,fields,oldFields));case 7:_context2.next=9;return regeneratorRuntime.awrap(
