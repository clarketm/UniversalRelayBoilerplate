...
_fs2.default.readdirSync(directoryName).
filter(function(unitName){
if(_fs2.default.statSync(directoryName+unitName).
isDirectory()){
...
try{
_fs2.default.readdirSync(mutationsDir).
filter(function(mutationName){
...
console.log('Written: '+_path2.default.resolve('./configuration/graphql/_mutations.js'));
_fs2.default.writeFileSync('./configuration/graphql/_mutations.js',mutations.join('\r\n'),'utf8');
}
...
try{
_fs2.default.readdirSync(schemasDir).
filter(function(mutationName){
if(mutationName.endsWith('.js')){
var mutationNameNoJs=mutationName.substring(0,mutationName.length-3);
...
_fs2.default.writeFileSync('./configuration/graphql/_schemas.js',schemas.join('\r\n'),'utf8');
}

function getViewerFields(directoryName,viewerFieldsImports,viewerFieldsExports){
_fs2.default.readdirSync(directoryName).
filter(function(unitName){
if(_fs2.default.statSync(directoryName+unitName).
isDirectory()){
...
if(_fs2.default.statSync(directoryName+unitName+'/graphql/type/_ViewerFields.js').
isFile()){
...
console.log('Written: '+_path2.default.resolve('./configuration/graphql/_ViewerFields.js'));
_fs2.default.writeFileSync('./configuration/graphql/_ViewerFields.js',viewerFields.join('\r\n'),'utf8');
}
