...
console.log('Written: '+_path2.default.resolve('./configuration/graphql/defaultPersister.js'));
_fs2.default.writeFileSync('./configuration/graphql/defaultPersister.js',defaultPersister.join('\r\n'),'utf8');
}
...
updateDefaultPersister(persisterFileName);else
...
for(var name in supportedPersisters){
console.error("  "+name);}
}
