...
var _schema=require('../graphql/schema');var _schema2=_interopRequireDefault(_schema);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}

var file_schema_json=_path2.default.join(__dirname,'../configuration/graphql/schema.json');
var file_schema_graphql=_path2.default.join(__dirname,'../configuration/graphql/schema.graphql');
