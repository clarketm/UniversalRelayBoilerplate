...
assetsPath=siteInformation.isSiteBuilderDisabled||
siteInformation.inEditingMode?"/assets/"+_package.version:"/assets-site/"+_package.version+"."+
...
function reunderOnServerCorrectRequest(
req,
res,
next,
assetsPath,
...
onError:function onError(errors,request){return(
...
if(md.phone())innerWidth=700;else
if(md.tablet())
...
_react2.default.createElement(_Wrapper2.default,{innerWidth:innerWidth},
isomorphicResponse));
...
meta:helmet.meta,
link:helmet.link,
backgroundColor:_muiTheme2.default.palette.backCanvas.
viewportBackgroundColor,
isomorphicVars:isoVars,
configurationAsObject:JSON.stringify(
siteInformation.inEditingMode||
...
"error",
res,
"renderOnServer render funcion failed",
err);

}
}

_isomorphicRelayRouter2.default.prepareData(renderProps,networkLayer).then(
render,
next);
